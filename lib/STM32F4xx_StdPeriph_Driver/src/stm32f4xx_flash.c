...
/**
  ...
  *            @arg FLASH_FLAG_PGAERR: FLASH 程序校准错误标志 
  *            @arg FLASH_FLAG_PGPERR: FLASH 程序并行错误标志
  *            @arg FLASH_FLAG_PGSERR: FLASH 程序顺序错误标志
  *            @arg FLASH_FLAG_RDERR: FLASH读保护错误标志(STM32F42xx/43xxx和STM32F401xx/411xE设备)
  * @retval None
  */
